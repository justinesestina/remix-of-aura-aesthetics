...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Maison Aesthetica — Private Cosmetic Surgery Clinic" },
      {
        name: "description",
        content:
      ...
      { property: "og:site_name", content: "Maison Aesthetica" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Private cosmetic surgery and aesthetic medicine practice offering consultation-led surgical and non-surgical care.",
        }),
      },
    ],
  }),
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <Header />
      <main id="main" className="page-in min-h-screen">
